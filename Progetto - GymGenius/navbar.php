...
<head>
    ...
    <script>
        $(document).ready(function(){
            $('#pop').popover({
                content: '<a class="popover" href="/pg_personali/logout.php">Logout</a>',
                html: true,
                placement: 'bottom'
            }); 
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavDropdown">
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" id="pop" data-bs-toggle="popover" data-bs-placement="bottom" data-bs-content="prova"><i class="bi bi-gear-fill"></i></a>
                            </li>
                            <li class="nav-item">
