...
<body id="bd-schede">
    ...
    <p class="schede-gratis-main-text">
      In questa pagina troverai una vasta selezione di schede gratuite per aiutarti a raggiungere i tuoi obiettivi di fitness! 
      ...
      adatto ai tuoi obiettivi e di fornirti tutto il supporto di cui hai bisogno. Cosa aspetti?</p>
        ...
        <div class="container_meteo">
            <div class="primo_meteo" >
                <h2>Meteo GymGenius</h2>
                <input class="form-control" type="text" id="city" placeholder="Cerca per località" style="margin-bottom: 10px;">
                <button class="btn bottone-form" onclick="getWeather()">Cerca</button>
            </div>
            <div class="sottogriglia_meteo">
                <div class="secondo_meteo" >
                    <h4 style="color: black; font-weight: bold;" id="h4_secmeteo">Allenamento all'aperto?</h4>
